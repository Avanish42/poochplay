<html>
<head>
<title>Add Other Vaccination</title>
</head>
<body>
<?php echo $error;?>
<h3>API URL: http://164.132.170.155/WebService/addothervaccination</h3>

<?php echo form_open_multipart('WebService/addothervaccination');?>
