<?php
/*
 * File Name: Otherworm_model.php
 */
if (!defined('BASEPATH'))
    exit('No direct script access allowed');

class Otherworm_model extends CI_Model {
	...
	$data['id'] = $id;
        ...
        $this -> db -> insert('pet_worm_other', $data);
	return $id;
    }

    function getNewid() {
        $sql = "select max(id) as mid from pet_worm_other";
    ...
    function update_worm($id,$data) {
        ...
        $this -> db -> update('pet_worm_other', $data);
    }
    
    //delete worm
    function delete_worm($id) {
        $this -> db -> where('vacc_id', $id);
        $this -> db -> delete('pet_worm_other');
    }    
